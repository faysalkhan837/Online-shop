            ...
            <div className="grid items-center w-full grid-cols-1 gap-0 mx-auto lg:grid-cols-11 lg:gap-24 xl:w-11/12">
                ...
                <div className="col-auto md:col-span-5 w-full">
                    <div className="mt-2 bg-slate-100 px-5 py-2 rounded-md">
                        <div className="">
                            <h1 className="text-5xl font-bold">Login User</h1>
                            <form onSubmit={handleLogin} action="#" className="space-y-6 mt-3">
                                <div>
                            ...
                            <p className="py-2 text-sm text-center">Are you new hare, go to <Link to='/signUp'><span className="text-blue-700">Sign Up</span></Link></p>
                        </div>
                    </div>
                </div>
            </div>
